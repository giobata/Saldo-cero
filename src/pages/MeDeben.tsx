...
export default function MeDeben({ debts, onAdd, onToggle, onDelete }: Props) {
    ...
    return (
      <div className={`entry-card ${d.paid ? 'paid' : ''}`}>
        ...
        <div className="entry-right">
          <div className="entry-amount blue">{formatCOP(d.amount)}</div>
      ...
      <Modal isOpen={open} onClose={() => setOpen(false)} title="¿Quién te debe?">
        <form className="form" onSubmit={handleSubmit}>
          ...
          <div className="field">
            ...
            <input
              type="text"
              placeholder="Ej: Préstamo para viaje..."
              value={desc}
